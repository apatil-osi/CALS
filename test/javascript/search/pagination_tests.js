...
describe('Facility Search pagination', function () {
  ...
  it('verify number of facilities dropdown after component render', () => {
    let dropDownFacilities = paginationCompRendered.find('.number_of_facilities')
  ...
  it('verify dropDown value change number of facilities', () => {
    let dropdownForfacilitiesCount = paginationCompRendered.find('.number_of_facilities')
  ...
  it('verify clicking next button ', () => {
    let searchFacility = paginationCompRendered.find('.next')
  ...
  it('verify clicking previous button ', () => {
    let searchFacility = paginationCompRendered.find('.previous')
    searchFacility.simulate('click')
